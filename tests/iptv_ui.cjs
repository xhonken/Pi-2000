...
(async()=>{
 ...
 try{
  ...
  await page.screenshot({path:path.join(process.env.PI2000_TEST_ARTIFACTS,'iptv-hls.png')});
  ...
  await page.screenshot({path:path.join(process.env.PI2000_TEST_ARTIFACTS,'iptv-narrow.png')});
