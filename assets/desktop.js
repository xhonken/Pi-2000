...
function render() {
 ...
 category('Development and Drawing',[button('Code Editor','editor'),button('MariaDB Manager','database'),button('API Tester','apitester'),button('Git Projects','git'),button('Arduino Workshop','arduino'),button('Dimension Drawing','cad')],'editor');
