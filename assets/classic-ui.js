...
const actionIcons={database:'devices',taskmanager:'activities',computer:'computer',files:'files',devices:'devices',browser:'browser',editor:'editor',cad:'cad',calculator:'calculator',notes:'notes',search:'search',sftp:'sftp',activities:'activities',status:'status',preferences:'settings',settings:'settings',users:'users',password:'users',trash:'recycle',links:'link',add:'link',help:'help',run:'run',logout:'logout',shutdown:'computer'};
const typeIcons={'database-window':'devices','taskmanager-window':'activities','explorer-window':'devices','files-window':'files','trash-window':'recycle','terminal-window':'run','users-window':'users','browser-window':'browser','status-window':'status','editor-window':'editor','preview-window':'file','search-window':'search','activities-window':'activities','notes-window':'notes','preferences-window':'settings','sftp-window':'sftp','cad-window':'cad','calculator-window':'calculator'};
const help={
 'database-window':'Save private MariaDB connections, then connect with your database account. Select a database and table in Object Explorer. Execute runs the selected SQL or the whole query (Ctrl+Enter). Save Workspace (Ctrl+S) preserves SQL tabs for your account. Administration templates prepare editable SQL; inspect it before Execute. SQL writes autocommit unless you start a transaction; MariaDB DDL may implicitly commit. Cancel Query disconnects this session. CSV export contains only the displayed result, not a complete backup. TLS verifies server identity; use unencrypted mode only on trusted networks.',
...
const configs={
 'database-window':{keep:null,groups:[['File','f',['New Connection','New Query','Save Workspace','Import SQL / CSV','Download SQL','Export CSV','Export Result SQL']],['Connection','c',['Connect','Disconnect']],['Query','q',['Execute','Cancel Query','Explain']],['View','v',['Refresh Objects']]]},
