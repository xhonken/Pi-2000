...
sudo -n install -m 644 "$project_dir/assets/system-icons.css" "$project_dir/assets/classic-icons.css" "$project_dir/assets/classic-ui.css" "$project_dir/assets/classic-ui.js" "$project_dir/assets/phpmyadmin.js" "$project_dir/assets/phpmyadmin.css" "$project_dir/assets/database.js" "$project_dir/assets/database-admin.js" "$project_dir/assets/sql-builder.js" "$project_dir/assets/database.css" "$project_dir/assets/development.js" "$project_dir/assets/git.js" "$project_dir/assets/arduino.js" "$project_dir/assets/arduino.css" "$project_dir/assets/development.css" "$project_dir/assets/taskmanager.js" "$project_dir/assets/taskmanager.css" "$project_dir/assets/desktop.css" "$project_dir/assets/files.js" "$project_dir/assets/editor.js" "$project_dir/assets/editor-sftp.js" "$project_dir/assets/tools.js" "$project_dir/assets/cad.js" "$project_dir/assets/sketch-geometry.js" "$project_dir/assets/calculator.js" "$project_dir/assets/icon-layout.js" "$project_dir/assets/apps.js" "$project_dir/assets/desktop.js" "$project_dir/assets/devices.js" "$project_dir/assets/devices.css" /srv/win2k/assets/
