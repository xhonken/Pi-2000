...
sudo -n install -m 644 "$project_dir/assets/system-icons.css" "$project_dir/assets/classic-icons.css" "$project_dir/assets/classic-ui.css" "$project_dir/assets/classic-ui.js" "$project_dir/assets/taskmanager.js" "$project_dir/assets/taskmanager.css" "$project_dir/assets/desktop.css" "$project_dir/assets/files.js" "$project_dir/assets/editor.js" "$project_dir/assets/editor-sftp.js" "$project_dir/assets/tools.js" "$project_dir/assets/cad.js" "$project_dir/assets/sketch-geometry.js" "$project_dir/assets/calculator.js" "$project_dir/assets/icon-layout.js" "$project_dir/assets/apps.js" "$project_dir/assets/desktop.js" "$project_dir/assets/devices.js" "$project_dir/assets/devices.css" /srv/win2k/assets/
