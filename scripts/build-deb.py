...
def main():
    p=argparse.ArgumentParser();p.add_argument('--version',default='0.1.0~alpha.4-5');a=p.parse_args()
    ...
    for name in ('package_setup.py','Caddyfile.template'):copy(ROOT/'packaging'/name,'/usr/lib/pi2000web/'+name)
