...
This document is the design contract for **Win UI**, an independent Windows 2000-inspired web framework. New pages should reuse these rules and avoid modern cards, rounded chips and decorative shadows.
...
- Disable Help with `window.WIN_UI_CONFIG = { help: false }` or `data-help-enabled="false"`.
